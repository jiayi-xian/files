...
if toupper(substitute(system('uname'), '\n', '', '')) =~ 'DARWIN'
    ...
    for i in range(0, 9)
        ...
        if filereadable(python_path . '/3.' . i . '/lib/libpython3.' . i . 'm.dylib')
...
set guifont=Iosevka_Fixed:h14
"set guifont=Iosevka_Fixed:h14:cANSI:qDRAFT
...
imap <F2> <ESC>:w<CR>\ll\lv
nmap <F2> <ESC>:w<CR>\ll\lv

map <F3> <ESC>:NERDTreeMirror<CR>
map <F3> <ESC>:NERDTreeToggle<CR>

map <F4> <ESC>:call UltiSnips#RefreshSnippets()
